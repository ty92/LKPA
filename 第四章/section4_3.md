...
&emsp; &emsp;下面我们首先给出缺页异常处理程序的总体方案如图4.10所示，随后给出其详细流程图，其中的“地址”指当前进程执行时引起缺页的虚地址，“虚存区”指该地址所处的虚存区。SIGSEGV是当一个进程执行了一个无效的内存引用，或发生段错误时发送给它的信号，OOPS即Linux内核的不正确行为。

<div style="text-align: center">
<img src="4_10.png"/> 
</div>
<center>图4.10  缺页异常处理程序的总体方案</center>

实际上，缺页异常处理程序必须处理多种更细的特殊情况，它们不宜在总体方案中列出，详细流程图如图4.11。
<div style="text-align: center">
<img src="4_11.png"/>
</div>

<center>图4.11 缺页异常处理程序流程图</center>
